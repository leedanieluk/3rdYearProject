...
% assigned number of bandits, number of timesteps, number of actions, actual values and noise.
...
%function greedy(bandit_n, a_n, a_dis[], n_dis[]);
% CONSTANTS
bandit_n = 20;
actions_n = 5;
timesteps = 1000;
...
total_average_return_for_all_bandits = sum(tot_avg_rew) / bandit_n;
